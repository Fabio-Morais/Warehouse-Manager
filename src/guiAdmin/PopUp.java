...
public class PopUp {
	...
	public int showPopUpDataBaseError() {
		...
		JLabel lblNome2 = new JLabel("1Verificar a sua ligação à internet");
		panel.add(lblNome2);
	...
	public int showPopUpDataBaseError2() {
		...
		JLabel lblNome2 = new JLabel("2Verificar a sua ligação à internet");
		panel.add(lblNome2);
		return JOptionPane.showOptionDialog(null, panel, "Erro a ligar à base de dados", JOptionPane.YES_NO_CANCEL_OPTION,
	...
	public void showPopUpDataBaseSucess() {
		...
		panel.add(lblNome2);
		JOptionPane.showOptionDialog(null, panel, "Erro a ligar à base de dados", JOptionPane.YES_OPTION,
				JOptionPane.PLAIN_MESSAGE, icon, options1, options1[0]);	
	}
